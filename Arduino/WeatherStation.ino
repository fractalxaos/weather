...
void reportWeather() {
  ...
  /* Modified 2018-10-06 by J Owrey to include
   * port number with host name as required by
   * http protocol. Line below commented out.
   */
  //sDestServerAddr = strtok(sDestServerAddr, ":");
  ...
  client.print("Host: ");
  client.println(sDestServerAddr);
